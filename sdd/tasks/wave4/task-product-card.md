...
## Spec source
Read `sdd/specs/design.md` — contains `## DESIGN PATTERNS` (compound component pattern) and `## ANIMATION SYSTEM` (useFadeInUp, usePressScale, useStagger, useCartBounce).
Also read wave 1/2 outputs: `src/types/index.ts`, `src/hooks/useWishlist.ts`
