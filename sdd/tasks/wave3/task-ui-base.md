...
## Spec source
Read `sdd/specs/design.md` — contains `## DESIGN PATTERNS` and `## ANIMATION SYSTEM` (useScaleIn for EmptyState).
Read `sdd/specs/screens.md` — contains `## COMPONENT LOADING STATES` for EmptyState usage context.
