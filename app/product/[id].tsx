    ...
    <View className="flex-1 bg-bg">
      ...
      >
        <View className="px-4 pt-3">
          <View
            className="bg-surface rounded-3xl overflow-hidden p-3"
            style={{
            ...
            <ImageCarousel.Root images={product.images}>
              <View className="flex-row">
                <View className="flex-1 rounded-2xl overflow-hidden">
                  <ImageCarousel.Slide aspectRatio={1} />
                </View>
        ...
        <View className="px-4 mt-6">
          <View className="flex-row items-center">
            <Typography variant="heading2" className="flex-1 mr-3">
              {product.name}
            </Typography>
      ...
      >
        <View className="flex-row gap-3">
          <View className="flex-1">
            <Button variant="outline" fullWidth rounded="pill" onPress={handleAddToCart}>
              {t('product.addToCart')}
            </Button>
          </View>
          <View className="flex-1">
            <Button variant="primary" fullWidth rounded="pill" onPress={handleBuyNow}>
              {t('product.buyNow')}
            </Button>
          </View>
        </View>
