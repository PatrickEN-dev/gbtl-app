...
1.  package.json (all deps with exact versions above)
2.  babel.config.js
3.  tailwind.config.js
4.  metro.config.js
5.  global.css
6.  app.json
7.  tsconfig.json (strict: true, extends: expo/tsconfig.base)
...
Each file: first line is a comment with the exact file path.
Full implementation — no stubs, no TODOs, no placeholder returns.
